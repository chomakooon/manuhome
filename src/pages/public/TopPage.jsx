        ...
        <div className="katachi-ben-page">
                ...
                <div className="manga-magazine-cover">
                    ...
                    <div className="mag-header">
                        <div className="mag-title-group">
                            ...
                            <h1 className="mag-title-main">カタチらぼ</h1>
                    ...
                    <div className="mag-center-visual">
                        <picture>
                            ...
                            <img src={pixelDove} alt="カタチらぼ — イラスト制作・図解デザイン・漫画制作のビジュアルスタジオ" className="mag-dove-img" />
                        </picture>
                    ...
                    <div className="mag-headlines">
                        ...
                        <Link to="/about" className="mag-link-card mag-hl-4">
                            ...
                            <p className="mag-hl-desc">カタチらぼを運営するビジュアルデザイナー・まぬちゃんのプロフィール。</p>
                        </Link>
            ...
            <section className="business-section bs-white" aria-label="解決策">
                <div className="bs-header">
                    ...
                    <p className="bs-subtitle">
                        カタチらぼは、抽象的なビジネス概念を、ターゲットが「即断できる」視覚情報へ変換する
            ...
            <section className="business-section bs-white" aria-label="カタチらぼの強み">
                <div className="bs-header">
                    <h2 className="bs-title">カタチらぼが選ばれる理由</h2>
            ...
            <section className="business-section bs-light bs-manga-section" id="flow" aria-label="制作の流れ">
                ...
                <div className="bs-manga-flow-wrapper">
                    <picture>
                        ...
                        <img src={orderFlowManga} alt="カタチらぼの注文フロー：悩み相談→依頼→デザイン制作→完成納品の4ステップ" className="bs-manga-img" />
                    </picture>
                </div>
