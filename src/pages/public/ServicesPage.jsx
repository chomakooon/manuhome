                ...
                <aside className="kb-news-col kb-news-left">
                    ...
                    <div className="kb-news-profile-img-box">
                        <picture>
                            ...
                            <img src={studioGreetingImg} alt="カタチらぼ 代表 — ビジュアルデザイナー まぬちゃん" />
                        </picture>
                    </div>
                    ...
                    <div className="kb-news-intro-text">
                        <p>カタチらぼは、単なる「制作屋」ではありません。あなたのビジネスの核心を、顧客が即断できる「視覚資産」へと変換する戦略的パートナーです。</p>
                        ...
                        <div className="kb-news-article-lead">
                            ...
                            <div className="kb-news-center-visual">
                                ...
                                <picture>
                                    ...
                                    <img src={brandingStrategyImg} alt="カタチらぼのブランディング戦略 ― ビジュアルで収益を加速" />
                                </picture>
                            </div>
                            <p className="kb-news-article-body">
                                「伝えたい価値はあるのに、顧客に正しく伝わっていない」――この悩みは、個人事業主・中小企業に共通する最大の課題です。カタチらぼは、イラスト・漫画・図解を戦略的に活用し、0.1秒で顧客の心をつかむビジュアルを設計。ビジネスの成長を視覚面から支援します。
                            </p>
                        </div>
                    </div>
                ...
                <aside className="kb-news-col kb-news-right">
                    <div className="kb-news-brand-logo">
                        <div className="kb-news-brand-inner">
                            <picture>
                                ...
                                <img src={pixelDove} alt="カタチらぼ" style={{ width: '48px', height: '48px', objectFit: 'contain' }} />
                            </picture>
                        </div>
                    </div>
                    ...
                    <div className="kb-news-manga-sidebar">
                        ...
                        <picture>
                            ...
                            <img src={orderFlowManga} alt="カタチらぼ 注文フロー 4コマ漫画：悩み相談→依頼→制作→納品" className="kb-news-manga-thumb" />
                        </picture>
                    </div>
                </aside>
            </div>
            ...
            <footer className="kb-news-bottom">
                <div className="kb-news-corporate">
                    ...
                    <dl className="kb-news-corp-info">
                        <dt>名称</dt><dd>カタチらぼ / ビジュアルデザイン室</dd>
